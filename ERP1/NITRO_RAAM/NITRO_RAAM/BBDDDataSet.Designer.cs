...
namespace NITRO_RAAM {
    ...
    public partial class BBDDDataSet : global::System.Data.DataSet {
        ...
        public partial class UsuariosDataTable : global::System.Data.TypedTableBase<UsuariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UsuariosRow AddUsuariosRow(string User, string Pass) {
...
namespace NITRO_RAAM.BBDDDataSetTableAdapters {
    ...
    public partial class UsuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Usuarios] WHERE (([Id] = @Original_Id) AND ((@IsNull_User = 1 " +
                "AND [User] IS NULL) OR ([User] = @Original_User)) AND ((@IsNull_Pass = 1 AND [Pa" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Usuarios] ([User], [Pass]) VALUES (@User, @Pass);\r\nSELECT Id, " +
                "[User], Pass FROM Usuarios WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Usuarios] SET [User] = @User, [Pass] = @Pass WHERE (([Id] = @Original_Id) AND ((@IsNull_User = 1 AND [User] IS NULL) OR ([User] = @Original_User)) AND ((@IsNull_Pass = 1 AND [Pass] IS NULL) OR ([Pass] = @Original_Pass)));
SELECT Id, [User], Pass FROM Usuarios WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::NITRO_RAAM.Properties.Settings.Default.BBDDConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, [User], Pass \r\nFROM dbo.Usuarios";
        ...
        public virtual int Fill(BBDDDataSet.UsuariosDataTable dataTable) {
        ...
        public virtual BBDDDataSet.UsuariosDataTable CuentaEmple() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            BBDDDataSet.UsuariosDataTable dataTable = new BBDDDataSet.UsuariosDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BBDDDataSet.UsuariosDataTable dataTable) {
